...
public class EasyBookingRemoteFacade extends UnicastRemoteObject implements IEasyBookingRemoteFacade{
	...
	public boolean registrarUsuario(String email, String contrase�a, SistemaPago tipoPago, Aeropuerto aeroPref) throws RemoteException{
		System.out.println(" * RemoteFaçade registro: " + email + " / " + contrase�a + " / " + tipoPago + " / " + aeroPref);
		this.state = LoginService.getInstance().registrarUsuario(email, contrase�a, tipoPago, aeroPref);
